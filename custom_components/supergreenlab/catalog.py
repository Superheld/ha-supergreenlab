...
NUMBERS: tuple[EntityDef, ...] = (
    # ventilation curve
    EntityDef(platform="number", key="BOX_{box}_BLOWER_MIN", name="Box {box} Exhaust fan speed min",
              scope="box", unit="%", icon="mdi:fan-chevron-down", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_MAX", name="Box {box} Exhaust fan speed max",
              scope="box", unit="%", icon="mdi:fan-chevron-up", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_REF_MIN", name="Box {box} Exhaust fan reference from",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_REF_MAX", name="Box {box} Exhaust fan reference to",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_MIN", name="Box {box} Intake fan speed min",
              scope="box", unit="%", icon="mdi:fan-chevron-down", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_MAX", name="Box {box} Intake fan speed max",
              scope="box", unit="%", icon="mdi:fan-chevron-up", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_REF_MIN", name="Box {box} Intake fan reference from",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_REF_MAX", name="Box {box} Intake fan reference to",
              scope="box", max=2000, **_CFG),
    # watering
