...
SENSORS: tuple[EntityDef, ...] = (
    ...
    EntityDef(platform="sensor", key="BOX_{box}_BLOWER_DUTY", name="Box {box} Blower",
              scope="box", icon="mdi:fan", **_PCT),
    EntityDef(platform="sensor", key="BOX_{box}_FAN_DUTY", name="Box {box} Fan",
              scope="box", icon="mdi:fan", **_PCT),
...
NUMBERS: tuple[EntityDef, ...] = (
    # ventilation curve
    EntityDef(platform="number", key="BOX_{box}_BLOWER_MIN", name="Box {box} Blower speed min",
              scope="box", unit="%", icon="mdi:fan-chevron-down", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_MAX", name="Box {box} Blower speed max",
              scope="box", unit="%", icon="mdi:fan-chevron-up", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_REF_MIN", name="Box {box} Blower reference from",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_BLOWER_REF_MAX", name="Box {box} Blower reference to",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_MIN", name="Box {box} Fan speed min",
              scope="box", unit="%", icon="mdi:fan-chevron-down", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_MAX", name="Box {box} Fan speed max",
              scope="box", unit="%", icon="mdi:fan-chevron-up", **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_REF_MIN", name="Box {box} Fan reference from",
              scope="box", max=2000, **_CFG),
    EntityDef(platform="number", key="BOX_{box}_FAN_REF_MAX", name="Box {box} Fan reference to",
              scope="box", max=2000, **_CFG),
    # watering
...
SELECTS: tuple[EntityDef, ...] = (
    ...
    EntityDef(platform="select", key="BOX_{box}_FAN_REF_SOURCE",
              name="Box {box} Fan source (advanced)",
    ...
    EntityDef(platform="select", key="BOX_{box}_BLOWER_REF_SOURCE",
              name="Box {box} Blower source (advanced)",
